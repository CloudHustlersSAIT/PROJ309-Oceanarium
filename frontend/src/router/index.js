...
const router = createRouter({
  ...
  routes: [
    ...
    // Admin routes
    // -----------------------
    { path: "/home", name: "home", component: HomeView, meta: { requiresAuth: true, role: "admin" } },
    { path: "/dashboard", name: "dashboard", component: DashboardView, meta: { requiresAuth: true, role: "admin" } },
    { path: "/notifications", name: "notifications", component: NotificationsView, meta: { requiresAuth: true, role: "admin" } },
    { path: "/assets", name: "assets", component: AssetsView, meta: { requiresAuth: true, role: "admin" } },
    { path: "/bookings", name: "bookings", component: BookingsView, meta: { requiresAuth: true, role: "admin" } },
    { path: "/calendar", name: "calendar", component: CalendarView, meta: { requiresAuth: true, role: "admin" } },
