"""
Mock poller service for testing purposes.

Generates deterministic mock Clorian-style records and inserts them into
...
def run_mock_poller_service(
    ...
    """Execute one cycle of the mock poller within a provided connection/transaction."""
